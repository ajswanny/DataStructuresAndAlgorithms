...
int main() {
    ...
    archive_read_write_counts("bubble_sort_rw_data.csv", bubble_sort_rw_data, false);
    ...
    // Archive read and write data for Bubble Sort.
    archive_read_write_counts("insertion_sort_rw_data.csv", insertion_sort_rw_data, false);
    ...
    archive_read_write_counts("quick_sort_rw_data.csv", quick_sort_rw_data, false);
    ...
    archive_read_write_counts("heap_sort_rw_data.csv", heap_sort_rw_data, false);
    ...
    archive_read_write_counts("TWOSORT_shell_sort_rw_data.csv", shell_sort_rw_data, false);
    ...
    archive_read_write_counts("TWOSORT_alt_bubble_sort_rw_data.csv", alt_bubble_sort_rw_data, false);
